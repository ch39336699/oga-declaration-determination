...
public class KafkaReceiverConfig {
  ...
  public void receive(@Payload String payload,
    ...
    logger.info("OGA Declaration Determination Recieved: " + values[0] + " appID: " + appID + " Shipment: " + values[1]);
    if(appID.contains("1002"))
    {
      logger.info("OGA Declaration Determination Processing... " + values[1]);
