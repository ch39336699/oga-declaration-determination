...
import com.fedex.ics.worker.OGADeclarationDeterminationWorker;
...
public class KafkaReceiverConfig {
  ...
  @Autowired
  private OGADeclarationDeterminationWorker worker;
  ...
  public Map<String, Object> consumerConfigs() {
      ...
      props.put(ConsumerConfig.GROUP_ID_CONFIG, "OGADeclDet");
  ...
  public void receive(@Payload String payload,
    ...
    if(appID.contains("1007"))
    {
      logger.info("OGA Declaration Determination Processing... TaskID:" + values[0]  + " OID:" + values[1]);
