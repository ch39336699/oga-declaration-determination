...
import com.fedex.ics.jpa.OGADeclarationDeterminationRepository;

@Component
public class OGADeclarationDeterminationWorker {
  
  private static final Log logger = LogFactory.getLog(OGADeclarationDeterminationWorker.class);
  @Autowired
  private OGADeclarationDeterminationRepository repo;  
